        ...
        <div class="flex justify-start items-center">
          ...
          <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
            <img
              ...
              alt="Flowbite Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Wadeh AI</span>
          </a>
          ...
          <ul class="flex flex-col mt-4 ml-8 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            <li>
                <a href="{{ route('home') }}" 
